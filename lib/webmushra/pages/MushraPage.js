...
MushraPage.prototype.init = function () {
  ...
  this.mushraAudioControl = new MushraAudioControl(this.audioContext, this.bufferSize, this.reference, this.conditions, this.errorHandler, this.pageConfig.createAnchor1k, this.pageConfig.createAnchor35, this.pageConfig.createAnchor70, this.pageConfig.createConditionAnchor1k, this.pageConfig.randomize, this.pageConfig.includeReference);
